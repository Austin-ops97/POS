...
export const demoAuthContext: AuthContext = {
  ...
  employee: {
    ...
    phone: null,
    pinHash: null,
    hourlyWage: 35 as unknown as import("@prisma/client").Prisma.Decimal,
    ptoBalanceHours: 120 as unknown as import("@prisma/client").Prisma.Decimal,
    ptoAnnualHours: 120 as unknown as import("@prisma/client").Prisma.Decimal,
    sickBalanceHours: 0 as unknown as import("@prisma/client").Prisma.Decimal,
    ptoCarryoverLimit: null,
    ptoAccrualPolicy: "ANNUAL_GRANT",
    legalFirstName: "Alex",
    legalLastName: "Owner",
    legalMiddleName: null,
    preferredName: null,
    displayNameStrategy: "LEGAL",
    dateOfBirth: null,
    personalEmail: null,
    workEmail: "demo@nexapos.com",
    mobilePhone: null,
    secondaryPhone: null,
    ...
    managerId: null,
    defaultLocationId: DEMO_LOCATION_ID,
